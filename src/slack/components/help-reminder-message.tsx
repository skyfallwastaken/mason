...
export function buildHelpReminderBlocks(threadTs: string): KnownBlock[] {
  return JSXSlack(
    <Blocks>
      <Section>
        :rac_info: Ah, hello! While we wait for a human to come and help you out, I&apos;ve been
        told to remind you to:
        {"\n\n"}• Have a read of the <a href="https://hackatime.hackclub.com/docs">docs</a> - it
